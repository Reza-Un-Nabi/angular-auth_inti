...
@Component({
  selector: 'app-univ-feature-invoice',
  templateUrl: './univ-feature-invoice.component.html',
  styleUrls: ['./univ-feature-invoice.component.css']
})
export class UnivFeatureInvoiceComponent implements OnInit {

  constructor() { }
  displayedColumns: string[] = ['invoiceId','entrydate', 'name', 'institute', 'course','agent','subtotal','totalGst','action'];

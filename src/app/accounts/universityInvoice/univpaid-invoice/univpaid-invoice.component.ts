...
@Component({
  selector: 'app-univpaid-invoice',
  templateUrl: './univpaid-invoice.component.html',
  styleUrls: ['./univpaid-invoice.component.css']
})
export class UnivpaidInvoiceComponent implements OnInit {
